...
/**
 * packageName    : com.psj.itembrowser.cart.data fileName       : CartMockDataGenerator author
 *    : ipeac date           : 2023-10-22 description    :
 * =========================================================== DATE              AUTHOR
 * NOTE ----------------------------------------------------------- 2023-10-22        ipeac       최초
 * 생성
 */
public class CartMockDataGenerator {
    ...
    public static Product createProduct(Long id, String name, Integer category, String detail,
        ProductStatus status, Integer quantity,
        ...
        return new Product(id, name, category, detail, status, quantity, unitPrice, sellerId,
            sellStartDatetime,
            sellEndDatetime, displayName, brand, deliveryFeeType, deliveryMethod,
            deliveryDefaultFee,
            freeShipOverAmount, returnCenterCode, createdDate, updatedDate, cartProductRelations);
    }
    
    public static CartProductRequestDTO createCartProductRequestDTO(Long cartId, Long productId,
        Integer quantity) {
        return createCartProductRequestDTO(cartId, productId, "sampleUser", quantity);
    }
    
    public static CartProductUpdateRequestDTO createCartProductUpdateRequestDTO(Long cartId,
    ...
    public static CartProductDeleteRequestDTO createCartProductDeleteRequestDTO(Long cartId,
        Long productId) {
        return new CartProductDeleteRequestDTO(cartId, productId);
    }
    
    public static Product createSimpleProduct(Long id, String name, Integer category,
        Integer quantity, Integer unitPrice) {
        return createProduct(id, name, category, "detail", ProductStatus.APPROVED, quantity,
            unitPrice, "seller1",
            LocalDateTime.now(), LocalDateTime.now(), "displayName", "brand", "deliveryFeeType",
            "deliveryMethod",
    ...
    public static CartProductRelation createCartProductRelation(Long cartId,
        ...
        Cart cart,
        Product product) {
        return new CartProductRelation(cartId, productId, productQuantity, cart, product,
            createdDate, updatedDate, deletedDate);
    }
    
    public static CartResponseDTO createCartResponseDTO(String userId,
