...
/**
 * packageName    : com.psj.itembrowser.cart.api
 * fileName       : CartApiControllerTest
 * author         : ipeac
 * date           : 2023-10-25
 * description    :
 * ===========================================================
...
class CartApiControllerTest {
    ...
    class SelectTest {
                    ...
                    .andDo(MockMvcRestDocumentationWrapper.document(
                            ...
                            ResourceDocumentation.resource(ResourceSnippetParameters.builder()
                                    ...
                                    .responseFields(
                                            ...
                                            fieldWithPath("products[].cartId").description("장바구니 ID").optional().type(JsonFieldType.NUMBER),
                                            fieldWithPath("products[].productId").description("상품 ID").optional().type(JsonFieldType.NUMBER),
                                            fieldWithPath("products[].productQuantity").description("상품 수량").optional().type(JsonFieldType.NUMBER),
                                            fieldWithPath("products[].cart").description("장바구니 정보").optional().type(JsonFieldType.OBJECT),
                                            fieldWithPath("products[].product").description("상품 정보").optional().type(JsonFieldType.OBJECT)
                                    )
                                    .build()
                            )
                    ));
        ...
        void When_CartIsNull_Expect_Exception() throws Exception {
            // given
            when(cartService.getCart(anyString())).thenThrow(new NotFoundException(ErrorCode.CART_NOT_FOUND));
